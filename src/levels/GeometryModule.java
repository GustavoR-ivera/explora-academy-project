...
import java.awt.*;
public class GeometryModule extends JFrame {
	 ...
	 * Create the frame.
	 */
	public GeometryModule(ArrayList<Question> geometryQuestionsL1, ArrayList<Question> geometryQuestionsL2) {
		...
		lblNewLabel = new JLabel("WELCOME TO THE GEOMETRY MODULE");
		...
		btnNewButton_1.setBounds(49, 185, 280, 70);
		...
		btnNewButton.setBounds(378, 185, 280, 70);
		...
		lblNewLabel_2.setIcon(new ImageIcon(BiologyModule.class.getResource("/images/geometry.jpg")));
