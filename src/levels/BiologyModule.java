...
import java.awt.*;
public class BiologyModule extends JFrame {
	 ...
	 * Create the frame.
	 */
	public BiologyModule(ArrayList<Question> biologyQuestionsL1, ArrayList<Question> biologyQuestionsL2) {
		...
		lblNewLabel = new JLabel("WELCOME TO THE BIOLOGY MODULE");
		lblNewLabel.setBounds(53, 25, 595, 62);
		...
		btnNewButton_1.setBounds(71, 185, 280, 70);
		...
		btnNewButton.setBounds(385, 185, 280, 70);
		...
		lblNewLabel_2.setIcon(new ImageIcon(BiologyModule.class.getResource("/images/biology.jpg")));
